...
api_key_help = 'Please set your OpenAI API Key before using. Otherwise, the program will not run.'

api_key_caption = '''You can get your API Key from [OpenAI Dashboard](https://beta.openai.com/account/api-keys). If you don't have an account, Click [here](https://beta.openai.com/signup) to sign up for free. '''

temperature_help = 'Used to adjust the diversity of the response generated by ChatGPT.'

temperature_caption = '''🔥  The temperature is used to adjust the diversity of the response generated by ChatGPT. Lower temperature results in less random completions. As the temperature approaches zero, the model will become deterministic and repetitive. Higher temperature results in more random completions.. See [OpenAI API](https://platform.openai.com/docs/introduction) documentation: [Adjust your settings](https://platform.openai.com/docs/quickstart/adjust-your-settings)'''

github_author = 'https://github.com/gukt'
github_repo = 'https://github.com/gukt/streamlit-chatgpt'
